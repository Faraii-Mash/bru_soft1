...
def reg_user(supplied_username):
    ...
    # Initialize variable for wether the user already exists
    ...
    with open("user.txt", "r") as in_file:
        ...
        # Else user exists
            ...
            print("Sorry this username and password already exists!")
            if supplied_username == "admin":
                return admin_menu(supplied_username)
            else:
                return user_menu(supplied_username)
...
def add_task(supplied_username):
    ...
    today = date.today()
    today = str(today)
    add_task.write(today)
    add_task.write(",")
    add_task.write(task_due_date)
    add_task.write(",")
    add_task.write("No")
    add_task.write("\n")
    # close the file
    add_task.close()
    print("Your new task details have been saved. ")
